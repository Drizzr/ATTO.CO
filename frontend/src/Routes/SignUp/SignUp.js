        ...
        <section>
            ...
            <h1>Sign Up</h1>
                <div className="form__field">
                    <label htmlFor="email">
                        <span>Email</span>
                        <span className={validEmail ? "form__success" : "hide"}>
                ...
                <p id="pwdnote" className={pwdFocus && !validMatch ? "form__instructions" : "offscreen"}>
                    <span>
                        <FontAwesomeIcon icon={faInfoCircle} />
                    </span>
                ...
                <div className="form__field">
                    <label htmlFor="confirm_pwd">
                        Confirm Password:
                        <FontAwesomeIcon icon={faCheck} className={validMatch ? "form__success" : "hide"} />
                ...
                <p id="confirmnote" className={matchFocus && !validMatch ? "form__instructions" : "offscreen"}>
                    <span>
                        <FontAwesomeIcon icon={faInfoCircle} />
                    </span>
